 ...
 *   $information[cSHORTCODE_TMCEENH]=false
 ...
 *   timceenh - true if shortcode is a tinymce enhanced code
...
define('cSHORTCODE_TMCEENH','scTMCEEnh'); //default no
...
/**
 * Create a sim data array with default settings for a shortcode
...
function lrhsim_setup($aFile)
{
	...
	// Here because cannot be called from admin_init action
