...
function lrhsim_action_register_shortcode_information()
{
	...
	add_filter('sim_playlist','filter_sim_playlist',5);
	add_filter('sim_embed','filter_sim_embed',5);
}
...
function filter_sim_playlist($information)
{
	$informatino[cSHORTCODE_NAME]='Media Playlist';
	$information[cSHORTCODE_DESC]='Allows you to embed a list of media files.';
	$information[cSHORTCODE_SELFCLS]=true;
	$information[cSHORTCODE_TMCEENH]=true;
	$information[cSHORTCODE_OPARAMS]=
		array('type'=>'type of playlist; default=audio'
		);
	return $information;
}

function filter_sim_embed($information)
{
	$informatino[cSHORTCODE_NAME]='Embed items';
	$information[cSHORTCODE_DESC]='Allows you to embed items.';
	$information[cSHORTCODE_SELFCLS]=true;
	$information[cSHORTCODE_TMCEENH]=true;
	$information[cSHORTCODE_OPARAMS]=
		array('height'=>'height of media'
			,'width'=>'width of media'
		);
	return $information;
}
